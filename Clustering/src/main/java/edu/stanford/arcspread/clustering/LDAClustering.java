package edu.stanford.arcspread.clustering;
 ...
 */
public final class LDAClustering extends AbstractJob {
  ...
  private static final Logger log = LoggerFactory.getLogger(LDAClustering.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new LDAClustering(), args);
  }
  ...
  private static double runIteration(Configuration conf,
    ...
    job.setJarByClass(LDAClustering.class);
